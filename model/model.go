	...
	Roles = []Role{
		{
			...
			Skills: []RoleSkill{
				{ID: 2, Type: MartialArts, Name: "魔之狂"},
				{ID: 3, Type: MartialArts, Name: "天之渦"},
				{ID: 1, Type: MartialArts, Name: "天之爆"},
				{ID: 4, Type: MartialArts, Name: "闇之爆"},
				{ID: 5, Type: Magic, Name: "山河凝元·天地共引"},
				{ID: 6, Type: Magic, Name: "地之火·九天滅絕"},
			},
		},
		{
			ID:      2,
			...
			Skills: []RoleSkill{
				{ID: 7, Type: MartialArts, Name: "凝宇化空"},
				{ID: 8, Type: MartialArts, Name: "反神源"},
			},
		},
	}
}
